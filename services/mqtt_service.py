...
class MqttService:
    ...
    def clear_retained_messages(self) -> None:
        ...
        logging.info(f"Clearing {len(self.retained_topics)} tracked retained messages...")
    ...
    def clear_all_retained_messages(self) -> None:
        ...
        try:
            ...
            logging.info(f"Subscribed to {wildcard_topic} to discover retained messages")
            
            time.sleep(1)
            
            logging.info(f"Clearing {len(received_topics)} discovered retained messages")
